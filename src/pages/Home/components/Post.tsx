  ...
  return (
    ...
    >
      <View className="flex flex-row items-start">
        ...
        <View className="flex-1">
          ...
          >
            ...
            <Icon name="ellipsis-vertical" size={20} color="#292929" />
          </View>
          <Text style={{ fontSize: 15, marginTop: 2, marginRight: 12 }}>
            {message}
          </Text>
          {image && (
            <Image
      ...
      <View
        ...
        style={{ marginTop: 5, marginLeft: 60, marginRight: 10 }}
      >
        <View className="flex flex-row">
          <TouchableOpacity
            className="py-1.25 flex flex-row items-center"
            style={{ paddingVertical: 5, marginRight: 15 }}
          >
